  ...
  {showDropdown && (
    <div
      ...
      className={`absolute top-full right-0 mt-2 min-w-[220px] rounded-2xl shadow-lg z-50 p-4 animate-in fade-in-0 zoom-in-95 duration-200 ${
        dark ? 'bg-[#181825] text-[#D2D6EF]' : 'bg-white text-[#6331c9]'
      }`}
      style={{
    ...
    >
      ...
      <div className={`h-px my-2 ${dark ? 'bg-[#232336]' : 'bg-gray-200'}`} />
      
      {/* Integration info */}
      <div className="flex items-center gap-2 text-base p-2 opacity-85">
        {integrationActive === null ? (
          <svg width="20" height="20" fill="none">
            <circle cx="10" cy="10" r="9" stroke="#aaa" strokeWidth="2"/>
            <circle cx="10" cy="10" r="4" fill="#aaa" />
          </svg>
        ) : integrationActive ? (
          <svg width="20" height="20" fill="none">
            <circle cx="10" cy="10" r="9" stroke="#2ecc40" strokeWidth="2"/>
            <path d="M7 10.5l2 2 4-4" stroke="#2ecc40" strokeWidth="2" fill="none" />
          </svg>
        ) : (
          <svg width="20" height="20" fill="none">
            <circle cx="10" cy="10" r="9" stroke="#e74c3c" strokeWidth="2"/>
            <line x1="7" y1="7" x2="13" y2="13" stroke="#e74c3c" strokeWidth="2"/>
            <line x1="13" y1="7" x2="7" y2="13" stroke="#e74c3c" strokeWidth="2"/>
          </svg>
        )}
        {integrationActive === null
      ...
      <div className="flex items-center gap-2 text-base p-2 opacity-85">
        <svg width="20" height="20" fill="none">
          <circle cx="10" cy="10" r="9" stroke="#6331c9" strokeWidth="2"/>
          <text x="10" y="15" textAnchor="middle" fontSize="10" fill="#6331c9">i</text>
        </svg>
